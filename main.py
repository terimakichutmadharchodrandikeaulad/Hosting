...
TOKEN = os.getenv('8143907252:AAFIyGASx_lgB0nSRfp2ehL0GMHRP_Qr23o')
OWNER_ID_STR = os.getenv('7886153127')
ADMIN_ID_STR = os.getenv('7886153127')
YOUR_USERNAME = os.getenv('@EdiusMaster')
UPDATE_CHANNEL = os.getenv('@a001hck')
